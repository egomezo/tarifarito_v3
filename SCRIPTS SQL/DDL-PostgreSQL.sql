...
-- DROP TABLE NOTIFICACION_PROCESO CASCADE;
-- DROP TABLE HISTORICO_INFO_GENERAL CASCADE;
...
CREATE TABLE CAUSAL (
  ...
  NOMBRECAUSAL TEXT NOT NULL,
PRIMARY KEY(IDCAUSAL));

----------------------------
-- DDL TABLA SUBCAUSAL
----------------------------
CREATE TABLE SUBCAUSAL (
  CONSECUTIVO SERIAL NOT NULL,
  IDSUBCAUSAL INTEGER NOT NULL,
  NOMBRESUBCAUSAL TEXT NOT NULL,
  FK_IDCAUSAL INTEGER NOT NULL,
FOREIGN KEY(FK_IDCAUSAL) REFERENCES CAUSAL(IDCAUSAL));
...
----------------------------
-- CREACION DEL TRIGGER QUE SE EJECUTARA CUANDO SE INSERTEN DATOS EN LA TABLA PROCESO
----------------------------
...
----------------------------
-- DDL TABLA NOTIFICACION_PROCESO
----------------------------
CREATE TABLE NOTIFICACION_PROCESO (
...
----------------------------
-- DDL TABLA HISTORICO_INFO_GENERAL
----------------------------
CREATE TABLE HISTORICO_INFO_GENERAL (
  ...
  DEVUELTO TEXT NULL,
  R_MEMORANDO_DEVOLUCION_IG TEXT NULL,
  F_MEMORANDO_DEVOLUCION_IG TIMESTAMP WITH TIME ZONE,
  ARCHIVADO TEXT NULL,
  ACTO_ADMINISTRATIVO_ARCHIVO_PRELIMINAR TEXT NULL,
  F_ACTO_ADMINISTRATIVO_ARCHIVO_PRELIMINAR TIMESTAMP WITH TIME ZONE,
  ACUMULACION_PROCESOS TEXT NULL,
  ACTO_ADMINISTRATIVO_ACUMULACION TEXT NULL,
  F_ACTO_ADMINISTRATIVO_ACUMULACION TIMESTAMP WITH TIME ZONE,  
  EXPEDIENTE_ACUMULACION TEXT NULL,  
  RESOLUCION_DECISION TEXT NULL,
  F_DECISION TIMESTAMP WITH TIME ZONE,
  TIPO_DECISION INTEGER NULL,
  VALOR_SANCION DOUBLE PRECISION NULL,
  RESOLUCION_RECURSO TEXT NULL,
  F_RESOLUCION_RECURSO TIMESTAMP WITH TIME ZONE,
  DECISION_RECURSO INTEGER NULL,  
  DECISION_EN_FIRME INTEGER NULL,
  VALOR_SANCION_RECURSO DOUBLE PRECISION NULL,
  EN_FIRME TEXT NULL,
  FIRMEZA TEXT NULL,
  F_FIRMEZA TIMESTAMP WITH TIME ZONE,
  PRIMARY KEY(IDHISTORICO),
  UNIQUE (EXPEDIENTE, EMPRESA));

----------------------------
-- DDL TABLA HISTORICO_INFO_ESPECIFICA
----------------------------
CREATE TABLE HISTORICO_INFO_ESPECIFICA (
  IDHISTORICO SERIAL NOT NULL,
  EXPEDIENTE TEXT NOT NULL,
  EMPRESA BIGINT NOT NULL,
  SERVICIO INTEGER NOT NULL,
  ...
  CARGO TEXT NOT NULL,
  NORMA_INFRINGIDA TEXT NULL,
  CAUSAL INTEGER NOT NULL,
  SUB_CAUSAL INTEGER NOT NULL,
  PRIMARY KEY(IDHISTORICO),
  UNIQUE (EXPEDIENTE, EMPRESA, CARGO));
