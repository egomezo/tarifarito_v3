...
class TarifasService:
    ...
    def get_tarifas(self, r_tarifas_repository: TarifasRepository, objTarifas):
        print(f"started at {time.strftime('%X')}")
        valuesTarifas = []
        tarifas = []
        calculoTarifas = r_tarifas_repository.get_tarifas_bd(objTarifas)

        # print('-----------------------------')
        # print('TARIFAS >> ', calculoTarifas.dtypes)
        # print('-----------------------------')
