...
class ComponenteCService:

    def get_componenteC(self, r_componenteC_repository: ComponenteCRepository, componenteC):
        data = r_componenteC_repository.get_componenteC_bd(componenteC)
    ...
    def post(self, r_componenteC_repository: ComponenteCRepository, req):
        print("_________ POST MODEL _____________")
        print(req)
        print("_________________________________")
        # Insertar datos
        result = r_componenteC_repository.post_componenteC(req)
        return result
