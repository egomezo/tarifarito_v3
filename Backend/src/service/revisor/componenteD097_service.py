...
class ComponenteD097Service:

    def get_componenteD097(self, r_componenteD097_repository: ComponenteD097Repository, componenteD097):
        data = r_componenteD097_repository.get_componenteD097_bd(componenteD097)
        cpte = []
        cpte.append(
            {
    ...
    def post(self, r_componenteD097_repository: ComponenteD097Repository, req):
        print("_________ POST MODEL _____________")
        print(req)
        print("_________________________________")
        # Insertar datos
        result = r_componenteD097_repository.post_componenteD097(req)
        return result
