...
class ComponenteD015Service:

    def get_componenteD015(self, r_componenteD015_repository: ComponenteD015Repository, componenteD015):
        data = r_componenteD015_repository.get_componenteD015_bd(componenteD015)
        cpte = []
        for result in data:
            cpte.append({
                'ano': result[23],
    ...
    def post(self, r_componenteD015_repository: ComponenteD015Repository, req):
        print("_________ POST MODEL _____________")
        print(req)
        print("_________________________________")
        # Insertar datos
        result = r_componenteD015_repository.post_componenteD015(req)
        return result
